...
export function renderCharacterCard(character, {
  ...
  } else if (character.id === 'boingo' && isBoingoCircus && !character.isKO) {
    portrait.src = 'assets/images/boingo_circus.jpg';
  ...
  } else if (character.id === 'tharox' && isTharoxRoar && !character.isKO) {
    portrait.src = 'assets/images/tharox_roar.jpg';
  ...
  } else if (character.id === 'akyros' && isAkyrosRose && !character.isKO) {
    portrait.src = 'assets/images/akyros_rose.jpg';
  ...
  } else if (character.id === 'blade' && isBladeGuitar && !character.isKO) {
    portrait.src = 'assets/images/blade_guitar.jpg';
