...
export function renderCharacterCard(character, {
  ...
  isDivineLight, isRevived, isShaking, isClawed, clawCount, isDodging, isSmoking, isLaughing, isAthenaHealing, isTharoxGlory, isZerathysSoul, isAkyrosShadow, isChronoxTime, isAkyrosDodge, isBoingoHardpunch, isHoldingBall,
  ...
  // for him (explodes on someone else, or comes back to heal him) OR a
  // hard-punch portrait when a Chaos Gamble "win" roll lands, Athena
  ...
  // setBoingoHardpunch/setChronoxTime in dashboardScreen.js). Laughing takes
  // priority over hard-punch, and dodge takes priority over Shadow
  // Execution, in the unlikely case both pairs flash at once, since each is
  // the more immediate reactive moment. Velorya shows a "hidden" portrait
